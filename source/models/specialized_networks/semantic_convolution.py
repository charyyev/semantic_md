...
class SemanticConvolutionModel(nn.Module):
    def __init__(self, pretrained_model, semantic_out_channels, get_func, set_func):
        ...
        self.model = model_utils.extend_first_convolution(pretrained_model, semantic_out_channels, get_func, set_func)
        ...
        self.convolution = nn.Sequential(
            ...
            nn.Conv2d(in_channels=8, out_channels=semantic_out_channels, kernel_size=1, stride=1, bias=False),
