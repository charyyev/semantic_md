...
#
# https://github.com/apple/ml-hypersim/blob/main/code/python/tools/dataset_download_images.py
# python3 download_script.py --downloads_dir . --decompress_dir ./decompressed
